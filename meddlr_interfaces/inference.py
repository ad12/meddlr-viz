...
class MRIPerturbationInference(mk.gui.html.div):
    ...
    Use this interface to visualize reconstructions of MRI slices when affected
    by noise and motion artifacts.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            cache: Whether to cache the results.
                If ``True``, all results will be cached.
                If an integer, those many results will be cached.
        """
